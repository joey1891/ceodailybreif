      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            ...
            {/* 💡 새롭게 추가된 배너 관리 바로가기 */}
            <Link href="/admin/banners" className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-black hover:text-white transition-colors group border border-gray-200">
              <span className="font-bold">🖼️ 광고 배너 관리</span>
              <span className="text-gray-400 group-hover:text-white">→</span>
            </Link>
          </div>
        </div>
